...
public class Task_1 {
    ...
    public static int toOctal(int decimalNumber) {
        int numberInOctalSystem = 0;
        if (decimalNumber <= 0) {
            return numberInOctalSystem;
        }
        int i = 0;
        while (decimalNumber != 0) {
            numberInOctalSystem = numberInOctalSystem + (decimalNumber % 8) * (int) Math.pow(10, i++);
    ...
    public static int toDecimal(int octalNumber) {
        ...
        int i = 0;
        while (octalNumber != 0) {
            numberInDecimalSystem = numberInDecimalSystem + (octalNumber % 10) * (int) Math.pow(8, i++);
