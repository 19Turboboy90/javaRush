package com.JavaSyntaxPro.level_19.lecture_7.task_1;
...
Реализуй его, используя метод collect() объекта типа Stream<Integer>. В качестве параметра передай нужный коллектор (объект типа Collector<List<Integer>>).
...
public class Solution {
    ...
    public static List<Integer> getPositiveNumbers(Stream<Integer> numbers) {
        return numbers.filter(num -> num > 0).collect(Collectors.toList());
    }
}
