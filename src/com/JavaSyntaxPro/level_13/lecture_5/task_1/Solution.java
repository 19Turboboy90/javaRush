package com.JavaSyntaxPro.level_13.lecture_5.task_1;
...
public class Solution {
    ...
    public static void createNewPlanet(String planetName) {
        IntStream.range(0, planets.size()).filter(i -> planets.get(i).equals("Земля")).forEach(i -> planets.add(i + 1, planetName));
