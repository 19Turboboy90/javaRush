package com.JavaSyntaxPro.level_17.lecture_6.task_1;
...
public class Solution {
    ...
    static Set<LocalDateTime> convert(Map<LocalDate, List<LocalTime>> sourceMap) {
        ...
        sourceMap.forEach((key, value) -> value.stream().map(listTime -> LocalDateTime.of(key, listTime)).forEach(setLocalDateTime::add));
