package com.JavaSyntaxPro.level_17.lecture_2.task_2;
...
1. Если дата больше текущей, в ней нужно исправить эти две ошибки (год и месяц) с помощью методов setYear,
setMonth. Год задается с 1900, а месяцы нумеруются с нуля.
...
Требования:
•	Если дата больше текущей, метод fixDate должен исправить ее год и месяц.
•	Если дата меньше текущей, метод fixDate не должен ее изменять.
•	Метод fixDate должен проверять и исправлять все даты из списка brokenDates.
 */
